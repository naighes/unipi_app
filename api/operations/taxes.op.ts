...
const parseCareerId = (r: EX.Request) => {
...
export const taxesOp = (f: Fetch) => async (req: EX.Request, res: EX.Response): Promise<EX.Response> =>
    await TE.fold(
    ...
    (
        pipe(
            ...
            TE.fromEither,
            TE.chain(r => fetchTaxes(f)(r.token.cookie || {})(r.id))
        )
    )()
